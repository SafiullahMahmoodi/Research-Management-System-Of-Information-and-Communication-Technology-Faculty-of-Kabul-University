...
if ($lang == 'fa') {
    ...
    $heroText = "سیستم تحت وب مدیریت تحقیقات برای  پوهنځی تکنالوژی معلوماتی و مخابراتی(ICT)";

    $aboutTitle = "درباره سیستم";
    $aboutText = "این سیستم به منظور مدیریت فعالیت‌های تحقیقاتی در  پوهنځی تکنالوژی معلوماتی و   و توسعه یافته است. این سیستم امکان مدیریت استادان، محصلان، دیپارتمنت‌ها، مقالات علمی، پایان‌نامه‌ها، کتاب‌ها و کتاب‌های ترجمه‌شده را در یک محیط متمرکز فراهم می‌کند.";
